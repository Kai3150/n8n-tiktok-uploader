...
echo "🚀 Building r2-to-tiktok-poster Lambda deployment package..."
...
rm -f lambda_function.py __init__.py

echo "🎉 Build completed successfully!"
echo ""
echo "Next steps:"
echo "1. Deploy using AWS CLI:"
echo "   aws lambda update-function-code --function-name r2-to-tiktok-poster --zip-file fileb://lambda-deployment.zip"
echo ""
